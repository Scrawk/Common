...
namespace Common.Collections.Trees
{
    ...
    public class NewAVLTree<T> : BinaryTree<T> where T : IComparable<T>
    {
        ...
        public NewAVLTree(IEnumerable<T> items) : base(items)
        {
        ...
        private BinaryTreeNode<T> RotateLeftRight(BinaryTreeNode<T> node)
        {
            ...
            if (leftRight.Height == -1)
            {
                node.Height = 0;
                left.Height = 1;
            }
            else if (leftRight.Height == 0)
            {
                node.Height = 0;
                left.Height = 0;
            }
        ...
        private BinaryTreeNode<T> RotateRightLeft(BinaryTreeNode<T> node)
        {
            ...
            if (rightLeft.Height == 1)
            {
                node.Height = 0;
                right.Height = -1;
            }
            else if (rightLeft.Height == 0)
            {
                node.Height = 0;
                right.Height = 0;
            }
