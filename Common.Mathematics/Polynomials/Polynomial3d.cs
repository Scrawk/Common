...
namespace Common.Mathematics.Polynomials
{
    ...
    public struct Polynomial3d
    {
        ...
        public PolynomialRoots3d Solve()
        {
            return Solve(a, b, c, d);
        }

        public static PolynomialRoots3d Solve(double a, double b, double c, double d)
        {
            if (a == 0.0)
                throw new InvalidOperationException("First term in polynomial can not be 0.");
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct PolynomialRoots3d
    {
        public int real;
        ...
        {
            return string.Format("[PolynomialRoots3d: real={0}, x0={1}, x1={2}, x2={3}", real, x0, x1, x2);
        }
    }
}
