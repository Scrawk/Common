...
namespace Common.Core.Shapes
{
    ...
    public interface IShape2f
    {
        ...
        /// <param name="p"></param>
        /// <returns></returns>
        bool Contains(Point2f p, bool includeBorder = true);
        ...
        /// <returns></returns>
        bool Intersects(Box2f box, bool includeBorder = true);
    ...
    public abstract class Shape2f : IShape2f
    {
        ...
        /// <param name="p"></param>
        /// <returns></returns>
        public virtual bool Contains(Point2f p, bool includeBorder = true)
        {
        ...
        /// <param name="box"></param>
        /// <returns></returns>
        public virtual bool Intersects(Box2f box, bool includeBorder = true)
        {
            throw new NotImplementedException();
        }
