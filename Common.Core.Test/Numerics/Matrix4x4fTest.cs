...
namespace Common.Core.Test.Numerics
{
    ...
    public class Matrix4x4fTest
    {
        ...
        {
            Assert.IsTrue(Random4x4(0).AlmostEqual(Random4x4(0), 1e-6f));
        }
        ...
        public void Inverse()
        {
            Assert.IsTrue((Random4x4(0).Inverse * Random4x4(0)).AlmostEqual(Matrix4x4f.Identity, 1e-6f));
        }
        ...
        public void TryInverse()
        {
            ...
            Assert.IsTrue((inverse * Random4x4(0)).AlmostEqual(Matrix4x4f.Identity, 1e-6f));
        }
