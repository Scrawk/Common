...
namespace Common.Meshing.FaceBased
{
    public static partial class FBOperations
    {
        ...
        /// </summary>
        public static Mesh2d ToTriangleMesh2d<VERTEX, FACE>(FBMesh<VERTEX, FACE> mesh)
        ...
        /// </summary>
        public static HBMesh2d ToHBTriangleMesh2d<VERTEX, FACE>(FBMesh<VERTEX, FACE> mesh)
            where VERTEX : FBVertex, new()
            where FACE : FBFace, new()
        {
            mesh.TagAll();
