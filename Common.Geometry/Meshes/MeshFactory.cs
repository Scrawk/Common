...
namespace Common.Geometry.Meshes
{
	...
	public static class MeshFactory
    {
		...
		public static Mesh3f CreatePlane(PlaneParams param)
		{
			...
			for (int iy = 0; iy < gridY1; iy++)
			{
				...
				for (int ix = 0; ix < gridX1; ix++)
				{
					...
					double u = ix * segment_width;
					double v = iy * segment_height;

					points.Add(new Point3f(x, y, 0));
					uv.Add(new Vector2f(u, v));
					normals.Add(Vector3f.UnitZ);
				}
			}
			...
			var mesh = new Mesh3f(points, triangles);
