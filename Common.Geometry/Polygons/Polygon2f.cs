...
namespace Common.Geometry.Polygons
{
    ...
    public class Polygon2f : Polyobject2f
    {
        ...
        public Polygon2f(IList<POINT2> positions) : base(positions)
        {
        ...
        public override REAL SignedDistance(POINT2 point)
        {
            ...
            REAL d = VECTOR2.Dot((point - v0).Vector2f, (point - v0).Vector2f);
            REAL s = 1.0f;
            ...
            for (int i = 0; i < Count; i++)
            {
                ...
                VECTOR2 e = (vj - vi).Vector2f;
                VECTOR2 w = (point - vi).Vector2f;
        ...
        /// </summary>
        public static Polygon2f FromTriangle(POINT2 a, POINT2 b, POINT2 c)
        {
        ...
        /// </summary>
        public static Polygon2f FromBox(POINT2 min, POINT2 max)
        {
        ...
        /// </summary>
        public static Polygon2f FromCircle(POINT2 center, REAL radius, int segments)
        {
            var polygon = new Polygon2f(segments);

            REAL pi = MathUtil.PI_32;
            REAL fseg = segments;
