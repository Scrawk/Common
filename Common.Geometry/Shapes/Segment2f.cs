...
namespace Common.Geometry.Shapes
{
    ...
    public struct Segment2f : IEquatable<Segment2f>, IShape2f
    {
        ...
        public static Segment2f operator +(Segment2f seg, float s)
        {
            return new Segment2f(seg.A + s, seg.B + s);
        }

        public static Segment2f operator +(Segment2f seg, Vector2f v)
        {
        ...
        public static Segment2f operator *(Segment2f seg, Matrix2x2f m)
        {
        ...
        {
            return Vector2f.Distance(Closest(p), p);
        }
