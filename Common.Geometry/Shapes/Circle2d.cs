...
namespace Common.Geometry.Shapes
{
    ...
    public struct Circle2d : IEquatable<Circle2d>, IShape2d
    {
        ...
        public static implicit operator Circle2d(Circle2f cir)
        {
            return new Circle2d(cir.Center, cir.Radius);
        }
        ...
        /// </summary>
        private static Point2i ExtremePoints(IList<VECTOR2> points)
        {
