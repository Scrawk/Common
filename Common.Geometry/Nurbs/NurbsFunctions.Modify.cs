...
namespace Common.Geometry.Nurbs
{
    public static partial class NurbsFunctions
    {
        ...
        public static NurbsCurveData2f KnotRefine(NurbsCurveData2f curve, IList<float> knotsToInsert)
        {
            ...
            return new NurbsCurveData2f(degree, controlPoints_post, knots_post);
        }
        ...
        public static List<NurbsCurveData2f> DecomposeIntoBeziers(NurbsCurveData2f curve)
        {
            ...
            var crvs = new List<NurbsCurveData2f>(numCrvs);

            var i = 0;
            while (i < controlPoints.Length)
            {
                var kts = knots.Slice(i, crvKnotLength);
                var pts = controlPoints.Slice(i, reqMult);

                crvs.Add(new NurbsCurveData2f(degree, pts, kts));
