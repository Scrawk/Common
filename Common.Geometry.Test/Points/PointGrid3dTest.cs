...
namespace Common.Geometry.Test.Points
{
    ...
    public class PointGrid3fTest
    {
        ...
        public void Count()
        {
            ...
            var collection = new PointGrid3f<Point3f>(bounds, 0.5f);
        ...
        public void Add()
        {
            ...
            collection.Add(new Point3f(-5, -5, -5));
            points.Add(new Point3f(-5, -5, -5));
        ...
        public void AddOutOfBounds()
        {
            ...
            Assert.IsTrue(collection.Add(new Point3f(-4.999f, 4.999f, 4.999f)));
            Assert.IsFalse(collection.Add(new Point3f(-5.001f, 0, 0)));
            Assert.IsFalse(collection.Add(new Point3f(5.001f, 0, 0)));
            Assert.IsFalse(collection.Add(new Point3f(0, -5.001f, 0)));
            Assert.IsFalse(collection.Add(new Point3f(0, 5.001f, 0)));
            Assert.IsFalse(collection.Add(new Point3f(0, 0, -5.001f)));
            Assert.IsFalse(collection.Add(new Point3f(0, 0, 5.001f)));
        }
        ...
        public void Remove()
        {
            ...
            Assert.IsFalse(collection.Remove(new Point3f(10, 10, 10)));
            Assert.IsFalse(points.Remove(new Point3f(10, 10, 10)));
        ...
        public void Closest()
        {
            ...
            var collection = new PointGrid3f<Point3f>(bounds, 1);

            for (int i = 0; i <= 5; i++)
                collection.Add(new Point3f(i));

            Assert.AreEqual(new Point3f(0), collection.Closest(new Point3f(-1, -1, -1)));
            Assert.AreEqual(new Point3f(5), collection.Closest(new Point3f(6, 6, 6)));
        ...
        public void CompareToNaive()
        {
            ...
            var grid = new PointGrid3f<Point3f>(bounds, 0.5f, points);
            ...
            {
                var p = RandomPoint(i, bounds);
                var region = new Sphere3f(p.ToVector3f(), 0.1f);
        ...
        private List<Point3f> RandomPoints(int count, int seed, Box3f bounds)
        {
        ...
        private Point3f RandomPoint(int seed, Box3f bounds)
        {
            var rnd = new Random(seed);
            float x = bounds.Min.x + rnd.NextFloat() * bounds.Width;
            float y = bounds.Min.y + rnd.NextFloat() * bounds.Height;
